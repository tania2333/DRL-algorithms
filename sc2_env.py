...
class SC2Env(environment.Base):
  ...
  def __init__(self,  # pylint: disable=invalid-name
    ...
    if not 1 <= num_players <= 3 or not self._num_agents:
      raise ValueError(
  ...
  def _launch_mp(self, map_inst, interfaces):
    ...
    # print("self._num_agents", self._num_agents)
  ...
  def step_rewrite(self, actions, step_mul=None):
    """Apply actions, step the world forward, and return observations.
  ...
  def _observe(self):
    ...
    # for o in self._obs:
      # print("player_result", o.player_result)    #[player_id: 1 result: Victory, player_id: 2  result: Victory]    other times: [] [] ...
    # if(episode_complete):
      # print("episode_complete 1")
    ...
    # print("eps_steps", self._episode_steps)   #+++
    # print("eps_length", self._episode_length)    = 0
