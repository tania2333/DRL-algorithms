...
from learn_BicNet import learn
...
flags.DEFINE_integer("timesteps", 700000, "Steps to train")  #2000000  700000  test 1050  800000  700000 600000
...
def main():
  ...
  lr = FLAGS.lr
  buffer_size = 70000 # 50000   减少一下，尽量是训练步数的1/10  70000  test 200  80000
  batch_size = 32  # 32
  gamma = 0.99
  num_agents = 9
