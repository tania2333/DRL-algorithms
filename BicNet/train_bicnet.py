...
from smac.BicNet.bicnet import BiCNet as CommNet
...
class CriticNetwork(object):
    ...
    def __init__(self, sess, learning_rate, tau, num_actor_vars, num_agents, vector_obs_len, output_len, hidden_vector_len):
        ...
        self.predicted_q_value = tf.placeholder(tf.float32, (None, self.num_agents, 1), name="predicted_q_value")
    ...
    def create_critic_network(self, name):
        ...
        out = CommNet.critic_build_network(name, inputs, action, self.num_agents, self.hidden_vector_len)
